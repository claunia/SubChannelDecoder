...
{
    /// <summary>
    /// Provides a UNIX similar API to calculate CRC16CCITT (x^16 + x^12 + x^5 + 1).
    /// </summary>
    public class CRC16CCITTContext
    {
        ...
        /// <summary>
        /// Initializes the CRC16CCITT table and seed
        /// </summary>
        public void Init()
        {
            hashInt = 0xFFFF;
        ...
        {
            for (int i = 0; i < len; i++)
                hashInt = (ushort)((hashInt << 8) ^ table[data[i] ^ (hashInt>>8 & 0xFF)]);
        }
